 ...
 * @version $Id: CodeGen.java 262 2012-05-31 21:30:37Z mt $
 */
public interface CodeGen {
	 ...
	 * @throws YAPLException
	 */
	public Attrib allocArray(ArrayType arrayType, Token token)
	throws YAPLException;
	 ...
	 * @throws YAPLException
	 */
	public Attrib allocRecord(RecordType recordType, Token token)
	throws YAPLException;
	 ...
	 */
	public Attrib callProc(Symbol proc, List<Attrib> args, Token tok)
	throws YAPLException;
